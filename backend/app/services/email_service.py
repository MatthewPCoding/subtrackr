...
def build_success_redirect(profile: dict, subscriptions: list[dict]) -> str:
    ...
    return f"{FRONTEND_URL}/oauth-callback.html?oauth_connect=success&subs={encoded_subs}&profile={encoded_profile}"


def build_error_redirect() -> str:
    return f"{FRONTEND_URL}/oauth-callback.html?oauth_connect=error"
